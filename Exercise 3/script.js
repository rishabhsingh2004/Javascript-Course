let myjokes = [
  ...
  },
  {
    ...
    "safe": false,
    "lang": "en"
  } // this is the last joke in the array



]

let index = Math.floor(Math.random() * (myjokes.length - 1))// Generate a random index
console.log(index)
joke.innerHTML = myjokes[index].joke// Display the joke in the HTML element with id 'joke'
